...
vgg_mean = np.array([123.68, 116.779, 103.939], dtype=np.float32).reshape((1,1,3)) # change to (1,1,3) for tensorflow
...
class Vgg16():
    ...
    def create(self):
        ...
        model.add(Lambda(vgg_preprocess, input_shape=(224,224,3), output_shape=(224,224,3))) # change to (224,224,3) for tensorflow
